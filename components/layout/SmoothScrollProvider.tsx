 ...
 * sequences (sticky stacks, pinned sections, marquees) read the same scroll
 * position Lenis renders. Fully disabled under prefers-reduced-motion —
 * native scroll takes over and no raf loop runs.
 */
